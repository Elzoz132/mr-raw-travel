...
export const TripBookingWidget: React.FC<TripBookingWidgetProps> = ({ trip, selectedPackage }) => {
  ...
  const handleProceedToBooking = () => {
    updateBookingDraft({
      ...
      packageNameEn: selectedPackage ? selectedPackage.nameEn : undefined,
      packageNameAr: selectedPackage ? selectedPackage.nameAr : undefined,
      packageNameDe: selectedPackage ? selectedPackage.nameDe : undefined,
