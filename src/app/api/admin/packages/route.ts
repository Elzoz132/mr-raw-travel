  ...
  try {
    ...
    const created = await prisma.tripPackage.create({
      data: {
        ...
        packageColor,
        packageIcon,
        itinerarySteps: typeof itinerarySteps === 'object' ? JSON.stringify(itinerarySteps) : itinerarySteps,
  ...
  try {
    ...
    const updated = await prisma.tripPackage.update({
      ...
      data: {
        ...
        ...(data.minGuests !== undefined && { minGuests: Number(data.minGuests) }),
        ...(data.maxGuests !== undefined && { maxGuests: Number(data.maxGuests) }),
        ...(data.cancellationPolicyEn !== undefined && { cancellationPolicyEn: data.cancellationPolicyEn }),
        ...(data.cancellationPolicyAr !== undefined && { cancellationPolicyAr: data.cancellationPolicyAr }),
        ...(data.cancellationPolicyDe !== undefined && { cancellationPolicyDe: data.cancellationPolicyDe }),
        ...(data.meetingPointEn !== undefined && { meetingPointEn: data.meetingPointEn }),
        ...(data.meetingPointAr !== undefined && { meetingPointAr: data.meetingPointAr }),
        ...(data.meetingPointDe !== undefined && { meetingPointDe: data.meetingPointDe }),
        ...(data.googleMapsUrl !== undefined && { googleMapsUrl: data.googleMapsUrl }),
        ...(data.packageColor !== undefined && { packageColor: data.packageColor }),
        ...(data.packageIcon !== undefined && { packageIcon: data.packageIcon }),
        ...(data.itinerarySteps !== undefined && { itinerarySteps: typeof data.itinerarySteps === 'object' ? JSON.stringify(data.itinerarySteps) : data.itinerarySteps }),
