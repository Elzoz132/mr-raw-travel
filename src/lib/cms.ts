...
export const defaultHomepageConfig: HomepageConfig = {
  heroTitleEn: 'Unforgettable Red Sea Excursions & Boat Trips',
  heroTitleAr: 'رحلات البحر الأحمر والمغامرة السياحية المميزة',
  heroTitleDe: 'Unvergessliche Rotes Meer Ausflüge & Touren',
  ...
  heroSubtitleAr: 'استمتع بأفضل رحلات اليخوت الخاصة، ورحلات جزيرة جفتون وأورنج باي، وسفاري البيتش باجي الشامل، ورحلات الأقصر التاريخية.',
  heroSubtitleDe: 'Erleben Sie VIP-Privatyachten, Insel Giftun Ausflüge, Quad-Safaris und historische Luxor-Touren.',
  heroBadgeEn: '★ #1 Rated Tourism Company in Hurghada',
  heroBadgeAr: '★ الشركة رقم #1 لرحلات السياحة بالغردقة والبحر الأحمر',
  heroBadgeDe: '★ #1 Reiseveranstalter in Hurghada',
...
export const defaultFooterConfig: FooterConfig = {
  ...
  descriptionEn: 'The premier tourism platform in Hurghada, Egypt. Specializing in VIP private yacht charters, Giftun island sea trips, mega desert quad safaris, and ancient Luxor guided tours.',
  descriptionAr: 'منصة السياحة والرحلات البحرية الأولى في الغردقة، مصر. متخصصون في رحلات اليخوت الخاصة، وجزيرة جفتون وأورنج باي، وسفاري البيتش باجي، ورحلات الأقصر.',
  descriptionDe: 'Die führende Tourismusplattform in Hurghada, Ägypten. Spezialisiert auf VIP-Yachten, Giftun-Inselausflüge, Wüstensafaris und Luxor-Touren.',
  ...
  awards: ['Best Red Sea Tour Operator 2025', 'VIP Yacht Charter Award'],
